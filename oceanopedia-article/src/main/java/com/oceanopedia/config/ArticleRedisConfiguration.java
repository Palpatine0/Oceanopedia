package com.oceanopedia.config;

import com.oceanopedia.RedisConfiguration;
...
@Configuration
public class ArticleRedisConfiguration extends RedisConfiguration implements Serializable {
    @Bean
